<template>
  <div id="mainChatMessage" class="divMainChatiframe" style="display: block;">
    <p class="pcahtmessagTitle">{{ this.$t('gc.chat.title') }}</p>

<!--    <button type="button" class="xr-btn-z-index ml-1 v-btn v-btn&#45;&#45;is-elevated v-btn&#45;&#45;fab v-btn&#45;&#45;has-bg v-btn&#45;&#45;round theme&#45;&#45;light v-size&#45;&#45;x-small  xr-btn-normal xr-btn-ico" title="Закрыть"><span class="v-btn__content"><i aria-hidden="true" class="v-icon notranslate mdi mdi mdi mdi-window-close theme&#45;&#45;light"></i>&lt;!&ndash;&ndash;&gt;</span></button>-->
<!--    -->
<!--    -->
...
<!--    </v-btn>-->
    ...
    <XrBtn  id="btniframechat" @click="clickCloseChat" :title="$t('close')" style="position: absolute;
    z-index: 34;
    right: 4px;
    top: 6px;"
           :round="true" type="normal" icon="mdi mdi-window-close"
           class="ml-1"
    />
...
export default {
  ...
  mounted() {
    ...
    setTimeout(() => {
      This.addMeUserChat(1231232, 123, 'АК', '', 'https://ikdardev.com')
      This.addElTranslate()
  ...
  methods: {
    ...
    addMeUserChat(roomId, senderId, senderName, avatar, url) {
      ...
      this.userLang = 'ru'//(this.$route.params.lang).toUpperCase()
...
/*---------------------------------------------------------*/
.divMainChatiframe ::-webkit-scrollbar {
  height: 6px; /* высота для горизонтального скролла */
  width: 6px;
}

.divMainChatiframe ::-webkit-scrollbar-track {
  background: var(--xr-editor-menu-paginator-color);
}

.divMainChatiframe ::-webkit-scrollbar-thumb {
  background: var(--v-xr2L1-base);
  border-radius: 2px;
}

.divMainChatiframe ::-webkit-scrollbar-thumb:vertical:hover,
.divMainChatiframe ::-webkit-scrollbar-thumb:horizontal:hover {
  background: var(--v-xr2L1-base);
}
...
/*  background: #c847ff;*/
/*}*/
.divMainChatiframe :hover::-webkit-scrollbar-thumb {
  background: var(--v-xr2L1-base);
}
